                    ...
                    <div class="panel-body" >
                        ...
                        <ul id="myUL2" >
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-10">
                            <li class='myli'><a href="files/doc/test.pdf" class="list-group-item ">ll </a></li>
                                </div>
                                <div class="col-md-1">
                                 <a type="button" class="btn btn-xs btn-default" href="files/doc/test.pdf" download >
                                    <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-10">
                            <li class='myli'><a href="files/doc/test.pdf" class="list-group-item ">Policy####<span class="badge">New</span></a></li>
                                </div>
                                <div class="col-md-1">
                                 <a type="button" class="btn btn-xs btn-default" href="files/doc/test.pdf" download >
                                    <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>
