                    ...
                    <div class="panel-body" >
                        ...
                        <ul id="myUL" >
                            <div class="row myli">
                                ...
                                <div class="col-md-10">
                                    <li><a href="files/doc/test.pdf" class="list-group-item ">ll <span class="badge">New</span></a></li>
                                </div>
                                <div class="col-md-1">
                                    <a type="button" class="btn btn-sm btn-default nor" href="files/doc/test.pdf" download >
                            ...
                            <div class="row myli">
                                ...
                                <div class="col-md-10 ">
                                    <li><a href="files/doc/test.pdf" class="list-group-item ">Policy####</a></li>
                                </div>
                                <div class="col-md-1">
                                    <a type="button" class="btn btn-sm btn-default nor" href="files/doc/test2.pdf" download >
                                        <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>
                                    </a>
                                </div>
